...
foreach ($messages as $message) {
    ...
    $string =
        ...
        '                     <p >' . $message['content'] . '</p>' .
        '<li><a href="https://www.facebook.com/NOM">FACEBOOK <i class="fab fa-facebook-f" style="color:black"></i></a></li>'
        
        
                            //   '<a href="delete.php"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
