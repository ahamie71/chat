...
if (isset($_POST['submit'])) {
  ...
  if ($nbCaracter >= 6 && preg_match("/[a-z][0-9]/", $password)) {
    ...
    $req = $db->prepare("INSERT INTO user (name,password,role, LoginAttempts) VALUES (:name,:password,:role,:loginAttempts");
    $req->execute(
      array(
        ':name' => $name,
        ':password' => $pass,
...
<body>
  ...
  <div class="container mt-1">
    <form method="post">
      ...
      <input  name="LoginAttempts" type="hidden" value="LoginAttempts"placeholder="Password">
