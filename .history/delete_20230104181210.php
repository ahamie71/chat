...
if (!isset($_SESSION['user']) ){
    ...
    header('location:./view/ct.phtml');
    exit();
}
/**
 *  exsitznce du message id 
 * on cheque si le user est connecté 
 *  exsitznce du du message id en bdd
 * on peut verifier le user est l'auteur du message 
 */
...
if(isset($messageid) && $messageid <> $userid){
