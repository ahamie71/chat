...
// on a recuper avec la variable superglobale GET qui permet de recuper le paramètre rentré dans l'url , pour cela on veut l'id du message alors 
...
// donc la on a recupérer l'id du message, il nous reste a recupere l'author du message .
